...
//    BOOST_ASSERT_MSG(crypto_scalarmult(d, t, pubkey) == 0,
...
//    BOOST_ASSERT_MSG(crypto_scalarmult(d_prime, pk, T) == 0,
...
//                     "d and d_prime aren't equal");
    ...
    curve25519_sub(A_prime, S, D_prime);
    print_256(A_prime);
    curve25519_sub(A_prime, A_prime, C_prime);
    print_256(A_prime);
    print_256(A);
